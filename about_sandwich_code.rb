...
class AboutSandwichCode < Neo::Koan
  ...
  def find_line2(file_name)
    file_sandwich(file_name) do |file| # Rewrite find_line using the file_sandwich library function.
      while line = file.gets
        count = 1 if line.match(/e/)
      end
      count
    end
  end
  ...
  def test_finding_lines2
    assert_equal 1, find_line2('example_file.txt')
  end
